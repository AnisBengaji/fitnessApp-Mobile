...
import 'home_todo_model.dart';
export 'home_todo_model.dart';

class HomeTodoWidget extends StatefulWidget {
  const HomeTodoWidget({super.key});

  static String routeName = 'HomeTodo';
  static String routePath = '/homeTodo';
...
class _HomeTodoWidgetState extends State<HomeTodoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeTodoModel());
  }
                            ...
                            children: [
                                ...
                                child: Padding(
                                  ...
                                  child: StreamBuilder<List<TodoRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<TodoRecord> iconTodoRecordList =
                                          snapshot.data!;
                                      // Return an empty Container when the item does not exist.
                                      if (snapshot.data!.isEmpty) {
                                        return Container();
                                      }
                                      final iconTodoRecord =
                                          iconTodoRecordList.isNotEmpty
                                              ? iconTodoRecordList.first
                                              : null;
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed(WeatherWidget.routeName);
                                  },
                                  child: Icon(
                                    Icons.sunny_snowing,
                                    color: FlutterFlowTheme.of(context)
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed(CalendrierWidget.routeName);
                                },
                                child: Icon(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<TodoRecord>>(
                            stream: queryTodoRecord(
                              queryBuilder: (todoRecord) => todoRecord.where(
                                'isCompleted',
                                isEqualTo: true,
                              ),
                            ),
