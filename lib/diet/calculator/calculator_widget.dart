...
/// "Calculator" Page
/// This page will take user input and calculate their BMR & Daily Calories.
///
/// Text Fields (User Input)
///
/// Age (ageTextField)
/// Gender (genderDropdown → Options: Male, Female)
/// Weight (kg) (weightTextField)
/// Height (cm) (heightTextField)
/// Activity Level (activityDropdown → Options: Sedentary, Light, Moderate,
/// Active, Very Active)
...
class _CalculatorWidgetState extends State<CalculatorWidget> {
  ...
  void initState() {
    ...
    _model.ageTextFieldTextController ??=
        TextEditingController(text: _model.age.toString());
                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Enter your details below to calculate your Basal Metabolic Rate (BMR) and daily calorie needs.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.activityDropdownValue == null) {
                        return;
                      }
                      _model.bmr = (int age, double weight, double height,
                              String gender, String activityLevel) {
                        return gender == "Male"
                            ? (10 * weight) + (6.25 * height) - (5 * age) + 5
                            : (10 * weight) + (6.25 * height) - (5 * age) - 161;
                      }(
                          int.parse(_model.ageTextFieldTextController.text),
                          double.parse(
                              _model.weightTextFieldTextController.text),
                          double.parse(
                              _model.heightTextFieldTextController.text),
                          _model.genderDropdownValue!,
                          _model.activityDropdownValue!);
                      _model.dailycalories =
                          (double bmr, String activityLevel) {
                                ...
                                : activityLevel == "Moderate"
                                    ...
                                    : activityLevel == "Active"
                                        ...
                                        : activityLevel == "Very Active"
                                            ? bmr * 1.9
                                            : bmr;
                      }(_model.bmr, _model.activityDropdownValue!);
                      safeSetState(() {});

                      await BmrcalculationRecord.collection
                          .doc()
                          .set(createBmrcalculationRecordData(
                            bmr: _model.bmr,
                            age: int.tryParse(
                            ...
                            height: double.tryParse(
                                _model.heightTextFieldTextController.text),
                            activityLevel: _model.activityDropdownValue,
                          ));
                    },
                    text: 'Calculate',
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(TestAdd2Widget.routeName);
                      },
                      text: 'manage meals',
                      icon: Icon(
                        Icons.add_box,
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(TestXDWidget.routeName);
                      },
                      text: 'meals',
                      icon: Icon(
